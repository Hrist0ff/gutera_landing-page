      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Разтворете съдържанието на едно саше в чаша вода, разбъркайте, изчакайте 1–2 минути, разбъркайте отново и изпийте цялото количество.
          </p>
          <p className="text-gray-500 max-w-2xl mx-auto mt-2 text-sm">
            Препоръчителен дневен прием: едно саше сутрин преди храна или вечер след последното хранене за деня.
          </p>
        </div>
